...
// console.log(weather.getType(), weather.getPlace(), weather.getValue())


//     let prediction = weatherPrediction(25, 10, 2000, "VIA", "Rain", "mm")
//     let prediction2 = weatherPrediction(15, 10, 2000, "VIA", "Rain", "mm")

//     console.log(prediction.matches(weather))
//     console.log(prediction.getMax(), prediction.getMin())
